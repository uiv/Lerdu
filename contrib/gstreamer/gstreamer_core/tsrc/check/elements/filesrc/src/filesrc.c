...
#define LOG_FILE "c:\\logs\\filesrc_log1.txt"
#include "std_log_result.h"
#define LOG_FILENAME_LINE __FILE__, __LINE__
//char* xmlfile = "filesrc";
...
{
  GstElement *src;
xmlfile = "filesrc_test_reverse";
  std_log(LOG_FILENAME_LINE, "Test Started test_reverse");
...
void test_pull()
{
  ...
  GstBuffer *buffer1, *buffer2;
	xmlfile = "filesrc_test_pull";
  std_log(LOG_FILENAME_LINE, "Test Started test_pull");
  src = setup_filesrc ();
...
void test_coverage()
{
  ...
  GstBus *bus;
  GstMessage *message;
	xmlfile = "filesrc_test_coverage";
  std_log(LOG_FILENAME_LINE, "Test Started test_coverage");
  src = setup_filesrc ();
  bus = gst_bus_new ();
...
void test_uri_interface()
{
  GstElement *src;
  gchar *location;
  GstBus *bus;
	xmlfile = "filesrc_test_uri_interface";
  std_log(LOG_FILENAME_LINE, "Test Started test_uri_interface");
  src = setup_filesrc ();
  bus = gst_bus_new ();
