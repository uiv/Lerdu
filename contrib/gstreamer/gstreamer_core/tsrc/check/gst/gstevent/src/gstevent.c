...
#define LOG_FILE "c:\\logs\\gstevent_log1.txt" 
...
//  xmlfile = "gstevent_create_events";
  std_log(LOG_FILENAME_LINE, "Test Started create_events");
...
void send_custom_events()
{
  ...
  xmlfile = "gstevent_send_custom_events";
  std_log(LOG_FILENAME_LINE, "Test Started send_custom_events");
