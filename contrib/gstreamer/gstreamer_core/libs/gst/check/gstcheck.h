 ...
 * messages
 */
// These below variable has been defined in gstcheck.c
#if 0 
...
//#if EMULATOR
//GET_GLOBAL_VAR_FROM_TLS(_gst_check_raised_critical,gstcheck,gboolean)
//#define _gst_check_raised_critical (*GET_GSTREAMER_WSD_VAR_NAME(_gst_check_raised_critical,gstcheck,g)())
//#else 
//extern gboolean _gst_check_raised_critical;
//#endif
//
//#if EMULATOR
//GET_GLOBAL_VAR_FROM_TLS(_gst_check_threads_running,gstcheck,gboolean)
//#define _gst_check_threads_running (*GET_GSTREAMER_WSD_VAR_NAME(_gst_check_threads_running,gstcheck,g)())
//#else 
//extern gboolean _gst_check_threads_running;
//#endif
//
//#if EMULATOR
//GET_GLOBAL_VAR_FROM_TLS(_gst_check_expecting_log,gstcheck,gboolean)
//#define _gst_check_expecting_log (*GET_GSTREAMER_WSD_VAR_NAME(_gst_check_expecting_log,gstcheck,g)())
//#else 
//extern gboolean _gst_check_expecting_log;
//#endif
