...
gst_structure_get_abbrs (gint * n_abbrs)
{
  ...
  if (abbrs == NULL) {
    /* dynamically generate the array */
      ...
      dyn_abbrs[6].type=  GST_TYPE_BUFFER;

      dyn_abbrs[7].type= GST_TYPE_FOURCC;

      dyn_abbrs[8].type=  GST_TYPE_FOURCC;

      dyn_abbrs[9].type= GST_TYPE_FRACTION;
