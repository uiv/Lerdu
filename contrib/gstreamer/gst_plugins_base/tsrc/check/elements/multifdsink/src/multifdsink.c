...
#define LOG_FILE "c:\\logs\\multifdsink_logs.txt" 
...
void test_burst_client_bytes()
{
  ...
  std_log(LOG_FILENAME_LINE, "Test Started test_burst_client_bytes");
...
/* keep 100 bytes and burst 80 bytes to clients */
void test_burst_client_bytes_keyframe()
{
  GstElement *sink;
  GstBuffer *buffer;
  GstCaps *caps;
  ...
  std_log(LOG_FILENAME_LINE, "Test Started test_burst_client_bytes_keyframe");
...
test_add_client,
test_streamheader,
test_change_streamheader,
test_burst_client_bytes,
test_burst_client_bytes_keyframe,
test_burst_client_bytes_with_keyframe,
test_client_next_keyframe
};
