...
#define LOG_FILE "c:\\logs\\video_logs.txt" 
...
void test_video_formats()
{
  ...
  //xmlfile = "test_video_formats";
  std_log(LOG_FILENAME_LINE, "Test Started test_video_formats");
...
void test_dar_calc()
{
  ...
  //xmlfile = "test_dar_calc";
  std_log(LOG_FILENAME_LINE, "Test Started test_dar_calc");
...
void test_parse_caps_rgb()
{
  ...
  //xmlfile = "test_parse_caps_rgb";
  std_log(LOG_FILENAME_LINE, "Test Started test_parse_caps_rgb");
