...
#define LOG_FILE "c:\\logs\\pbutils_logs.txt" 
...
void test_pb_utils_post_missing_messages()
{
  GstElement *pipeline;
  GstStructure *s;
  GstMessage *msg;
  ...
  std_log(LOG_FILENAME_LINE, "Test Started test_pb_utils_post_missing_messages");
...
void test_pb_utils_init()
{
    std_log(LOG_FILENAME_LINE, "Test Started test_pb_utils_init");
...
void test_pb_utils_get_codec_description()
{
  gint i;
  
  std_log(LOG_FILENAME_LINE, "Test Started test_pb_utils_get_codec_description");
...
void test_pb_utils_taglist_add_codec_info()
{
  GstTagList *list;
  GstCaps *caps;
  
  std_log(LOG_FILENAME_LINE, "Test Started test_pb_utils_taglist_add_codec_info");
...
void test_pb_utils_install_plugins()
{
  GstInstallPluginsContext *ctx;
  GstInstallPluginsReturn ret;
  gchar *details[] = { "detail1", "detail2", NULL };
  
  std_log(LOG_FILENAME_LINE, "Test Started test_pb_utils_install_plugins");
...
void test_pb_utils_installer_details()
{
  GstMessage *msg;
  GstElement *el;
  GstCaps *caps;
  ...
  std_log(LOG_FILENAME_LINE, "Test Started test_pb_utils_installer_details");
...
void (*fn[]) (void) = {
test_pb_utils_init,
test_pb_utils_post_missing_messages,
test_pb_utils_taglist_add_codec_info,
test_pb_utils_get_codec_description,
test_pb_utils_install_plugins,
test_pb_utils_installer_details
};
