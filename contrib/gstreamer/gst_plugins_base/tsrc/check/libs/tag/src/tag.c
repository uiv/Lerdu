...
void test_parse_extended_comment()
{
  gchar *key, *val, *lang;
  
  xmlfile = "test_parse_extended_comment";
  std_log(LOG_FILENAME_LINE, "Test Started test_parse_extended_comment");
...
void test_muscibrainz_tag_registration()
{
  GstTagList *list;

  xmlfile = "test_muscibrainz_tag_registration";
  std_log(LOG_FILENAME_LINE, "Test Started test_muscibrainz_tag_registration");
...
void test_vorbis_tags()
{
  GstTagList *list;
  
  xmlfile = "test_vorbis_tags";
  std_log(LOG_FILENAME_LINE, "Test Started test_vorbis_tags");
  ...
  /* the same with an ID */
  {
    const guint8 vorbis_comments_buf[] = { 0x03, 'v', 'o', 'r', 'b', 'i', 's',0x03, 0x00, 0x00, 0x00, 'f', 'o', 'o', 0x01, 0x00, 0x00, 0x00, 14 /*strlen ("ARTIST=foo bar")*/, 0x00, 0x00, 0x00, 'A', 'R', 'T', 'I', 'S','T', '=', 'f', 'o', 'o', ' ', 'b', 'a', 'r'};
  //const guint8 vorbis_comments_buf[] = { 'a'};
    GstBuffer *buf;
    gchar *vendor = NULL;
...
void test_id3_tags()
{
  ...
  xmlfile = "test_id3_tags";
  std_log(LOG_FILENAME_LINE, "Test Started test_id3_tags");
...
void test_id3v1_utf8_tag()
{
  ...
  xmlfile = "test_id3v1_utf8_tag";
  std_log(LOG_FILENAME_LINE, "Test Started test_id3v1_utf8_tag");
...
tag_suite (void)
{
test_muscibrainz_tag_registration();
test_parse_extended_comment();
test_vorbis_tags();
test_id3_tags();
test_id3v1_utf8_tag();
}
