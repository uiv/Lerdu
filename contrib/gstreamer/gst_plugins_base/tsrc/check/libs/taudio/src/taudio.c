...
#define LOG_FILE "c:\\logs\\gstaudio_logs.txt" 
...
void test_buffer_clipping_time()
{
  GstSegment s;
  GstBuffer *buf;
  GstBuffer *ret;
  guint8 *data;
      	...
      	xmlfile = "test_buffer_clipping_time";
  std_log(LOG_FILENAME_LINE, "Test Started test_buffer_clipping_time");
...
void (*fn[4]) (void) = {
        test_multichannel_checks,
        test_buffer_clipping_time,
        test_buffer_clipping_samples,
        test_channel_layout_value_intersect
};
