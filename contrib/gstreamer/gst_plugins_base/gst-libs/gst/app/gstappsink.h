...
IMPORT_C void            gst_app_sink_set_caps       (GstAppSink *appsink, const GstCaps *caps);
IMPORT_C GstCaps *       gst_app_sink_get_caps       (GstAppSink *appsink);

IMPORT_C gboolean        gst_app_sink_is_eos         (GstAppSink *appsink);

IMPORT_C void            gst_app_sink_set_emit_signals (GstAppSink *appsink, gboolean emit);
IMPORT_C gboolean        gst_app_sink_get_emit_signals (GstAppSink *appsink);

IMPORT_C void            gst_app_sink_set_max_buffers  (GstAppSink *appsink, guint max);
IMPORT_C guint           gst_app_sink_get_max_buffers  (GstAppSink *appsink);

IMPORT_C void            gst_app_sink_set_drop         (GstAppSink *appsink, gboolean drop);
IMPORT_C gboolean        gst_app_sink_get_drop         (GstAppSink *appsink);
