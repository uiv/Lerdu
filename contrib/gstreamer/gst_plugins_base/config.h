...
#define GST_INSTALL_PLUGINS_HELPER "/home/rakhi/openlibs//libexec/gst-install-plugins-helper"
#else
#define GST_INSTALL_PLUGINS_HELPER "c:\data\gst-install-plugins-helper"
#endif
