...
protected:
  ...
  static GstClockReturn wait_vfunc_callback(GstClock* self, GstClockEntry* entry);
  ...
  static GstClockReturn wait_jitter_vfunc_callback(GstClock* self, GstClockEntry* entry, GstClockTimeDiff* jitter);
};
