...
#ifndef _GSTREAMERMM_AUDIOCONVERT_P_H
#define _GSTREAMERMM_AUDIOCONVERT_P_H
...
class AudioConvert_Class : public Glib::Class
{
public:
...
#endif /* _GSTREAMERMM_AUDIOCONVERT_P_H */
