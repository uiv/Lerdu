...
#ifndef _GSTREAMERMM_AUDIOTESTSRC_P_H
#define _GSTREAMERMM_AUDIOTESTSRC_P_H
...
class AudioTestSrc_Class : public Glib::Class
{
public:
...
#endif /* _GSTREAMERMM_AUDIOTESTSRC_P_H */
